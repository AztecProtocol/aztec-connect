...
TEST(schnorr, verify_signature_keccak256)
{
    ...
    bool result = crypto::schnorr::verify_signature<KeccakHasher, grumpkin::fq, grumpkin::fr, grumpkin::g1>(message, account.public_key, signature);
...
TEST(schnorr, verify_signature_sha256)
{
    ...
    bool result = crypto::schnorr::verify_signature<Sha256Hasher, grumpkin::fq, grumpkin::fr, grumpkin::g1>(message, account.public_key, signature);
