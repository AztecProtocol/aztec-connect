...
{
    plonk::stdlib::field_t<waffle::MiMCComposer> mimc_input(&mimc_composer, plonk::stdlib::witness_t(fr::random_element()));
    plonk::stdlib::field_t<waffle::MiMCComposer> mimc_k(&mimc_composer, plonk::stdlib::witness_t(fr::zero()));
