...
TEST(fq2, is_zero)
{
    ...
    b.c0.data[0] = 1;
    c.c1.data[0] = 1;
    EXPECT_EQ(fq2::is_zero(a), true);
    EXPECT_EQ(fq2::is_zero(b), false);
    EXPECT_EQ(fq2::is_zero(c), false);
}
...
TEST(fq2, mul_sqr_consistency)
{
    ...
    fq2::__sub(a, b, t1);
    fq2::__add(a, b, t2);
    fq2::__mul(t1, t2, mul_result);
    fq2::__sqr(a, t1);
    fq2::__sqr(b, t2);
    fq2::__sub(t1, t2, sqr_result);
...
TEST(fq2, invert)
{
    ...
    fq2::field_t inverse;
    fq2::field_t result;
    fq2::__invert(input, inverse);
    fq2::__mul(input, inverse, result);
