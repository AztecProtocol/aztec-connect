...
TEST(client_proofs, test_standard_example_c_bindings)
{
    ...
    scalar_multiplication::Pippenger pippenger("../barretenberg/cpp/srs_db/ignition", 32768);
    ...
    transcript.open("../barretenberg/cpp/srs_db/ignition/transcript00.dat", std::ifstream::binary);
