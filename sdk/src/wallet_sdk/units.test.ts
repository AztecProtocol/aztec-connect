...
describe('units', () => {
  it('should format correctly', () => {
    expect(fromBaseUnits(0n, 4, 2)).toBe('0.00');
    ...
    expect(fromBaseUnits(100000n, 4, 2)).toBe('10.00');
    expect(fromBaseUnits(199999n, 4, 2)).toBe('19.99');
    expect(fromBaseUnits(199000n, 4, 2)).toBe('19.90');
    expect(fromBaseUnits(198765n, 4)).toBe('19.8765');
    expect(fromBaseUnits(198765n, 4, 6)).toBe('19.8765');
