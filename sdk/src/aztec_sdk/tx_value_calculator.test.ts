...
import { TxValueCalculator } from './tx_value_calculator';
...
describe('tx value calculator', () => {
  ...
  beforeEach(() => {
    core = {
      ...
      getMaxSpendableNoteValues: jest.fn().mockResolvedValue([]),
      getSpendableNoteValues: jest.fn().mockResolvedValue([]),
      getSpendableSum: jest.fn().mockResolvedValue(0n),
