  ...
  describe('fee quotes', () => {
    it('return correct tx fee and fee quotes', async () => {
      {
        ...
        expect(feeCalculator.getMinTxFee(assetId, TxType.DEPOSIT)).toBe(650000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.TRANSFER)).toBe(50000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.WITHDRAW_TO_WALLET)).toBe(51700n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.WITHDRAW_TO_CONTRACT)).toBe(50000n);
      }

      {
        ...
        expect(feeCalculator.getMinTxFee(assetId, TxType.DEPOSIT)).toBe(1425000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.TRANSFER)).toBe(25000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.WITHDRAW_TO_WALLET)).toBe(26950n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.WITHDRAW_TO_CONTRACT)).toBe(25000n);
      }
    });
    ...
    it('return correct tx fee for free txTypes', async () => {
...

      {
        ...
        expect(feeCalculator.getMinTxFee(assetId, TxType.TRANSFER)).toBe(0n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.DEPOSIT)).toBe(650000n);
      }
    });
    ...
    it('round up fees', async () => {
      priceTracker.getGasPrice.mockImplementation(() => 12345n);
...

      {
        ...
        expect(feeCalculator.getMinTxFee(assetId, TxType.DEPOSIT)).toBe(163000000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.TRANSFER)).toBe(13000000n);
      }

      {
        ...
        expect(feeCalculator.getMinTxFee(assetId, TxType.DEPOSIT)).toBe(78400000n);
        expect(feeCalculator.getMinTxFee(assetId, TxType.TRANSFER)).toBe(1400000n);
      }
    });
  });
