...
import { LegacyRegisterInteractions } from './legacy_register';
import { useEffect, useRef, useState } from 'react';
import { getWagmiRainbowConfig } from './wagmi_rainbow_config';
...
import { RecoverAliasInteractions } from './recover_alias';
