...
struct Bn254Fq6Params
{
    ...
    static constexpr fq2::field_t frobenius_coeffs_c1_2{
        { { 0x3350c88e13e80b9cUL, 0x7dce557cdb5e56b9UL, 0x6001b4b8b615564aUL, 0x2682e617020217e0UL } },
        { { 0UL, 0UL, 0UL, 0UL } }
    };

    static constexpr fq2::field_t frobenius_coeffs_c1_3{
    ...
    static constexpr fq2::field_t frobenius_coeffs_c2_1{
    ...
    static constexpr fq2::field_t frobenius_coeffs_c2_2{
        { { 0x71930c11d782e155UL, 0xa6bb947cffbe3323UL, 0xaa303344d4741444UL, 0x2c3b3f0d26594943UL } },
        { { 0UL, 0UL, 0UL, 0UL } }
    };

    static constexpr fq2::field_t frobenius_coeffs_c2_3{
    ...
    // const typename base_field::base_field::field_t non_residue = {{ 0UL, 0UL, 0UL, 0 } };
