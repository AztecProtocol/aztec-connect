...
namespace waffle
{
    ...
    Prover BoolComposer::preprocess()
    {
        ...
        q_left_bools.emplace_back(fr::to_montgomery_form({{0,0,0,0}}));
        q_right_bools.emplace_back(fr::to_montgomery_form({{0,0,0,0}}));
        ...
        q_left_bools.emplace_back(fr::one());
        q_right_bools.emplace_back(fr::one());
        w_l.emplace_back(add_variable(fr::to_montgomery_form({{1,0,0,0}})));
