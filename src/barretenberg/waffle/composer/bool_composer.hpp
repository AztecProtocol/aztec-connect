...
class BoolComposer : public StandardComposer {
  public:
    BoolComposer(const size_t size_hint = 0)
        : StandardComposer()
    {
    ...
    uint32_t add_public_variable(const barretenberg::fr::field_t& in) override
    {
    ...
    void set_public_input(const uint32_t witness_index) override
    {
