...
num_witness_bits(32)
{
    ...
    num_witness_bits = std::max(num_witness_bits, additive_bits) + static_cast<uint32_t>(num_witness_bits == additive_bits);
...
template <typename ComposerContext>
uint32<ComposerContext> & uint32<ComposerContext>::operator=(const uint32 &other)
{
    context = other.context;
    witness = other.witness;
    witness_index = other.witness_index;
...
template <typename ComposerContext>
uint32<ComposerContext> & uint32<ComposerContext>::operator=(const uint32_t value)
{
    witness = barretenberg::fr::zero();
    witness_index = static_cast<uint32_t>(-1);
    additive_constant = value;
...
template <typename ComposerContext>
void uint32<ComposerContext>::concatenate()
{
...
// This allows us to defer 'decompositions' until neccessary - which in turn allows us to chain together multiple additions.
template <typename ComposerContext>
...
template <typename ComposerContext>
void uint32<ComposerContext>::prepare_for_logic_operations()
{
...
uint32<ComposerContext> uint32<ComposerContext>::operator*(uint32 &other)
{
    ...
    else
    {
        ...
        barretenberg::fr::field_t q_m = barretenberg::fr::to_montgomery_form(
            {{ static_cast<uint64_t>(qm_32), 0, 0, 0 }}
        );
        barretenberg::fr::field_t q_l = barretenberg::fr::to_montgomery_form(
            {{ static_cast<uint64_t>(ql_32), 0, 0, 0 }}
        );
        barretenberg::fr::field_t q_r = barretenberg::fr::to_montgomery_form(
            {{ static_cast<uint64_t>(qr_32), 0, 0, 0 }}
        );
        barretenberg::fr::field_t q_c = barretenberg::fr::to_montgomery_form(
            {{ static_cast<uint64_t>(qc_32), 0, 0, 0 }}
        );
...
uint32<ComposerContext> uint32<ComposerContext>::operator/(uint32 &other)
{
    ...
    else
    {
        ...
        uint32_t denominator_witness = static_cast<uint32_t>(barretenberg::fr::from_montgomery_form(other.witness).data[0]);
        ...
        result = uint32<ComposerContext>(context, witness_t(quotient_uint));
...
template <typename ComposerContext>
bool_t<ComposerContext> uint32<ComposerContext>::operator<(uint32 &other)
{
    prepare_for_arithmetic_operations();
    other.prepare_for_arithmetic_operations();
    ...
    bool_t<ComposerContext> predicate(context, witness_t(predicate_bool));

    field_t<ComposerContext> left = other.accumulators[31];
    left.multiplicative_constant = barretenberg::fr::to_montgomery_form({{ static_cast<uint64_t>(other.multiplicative_constant), 0, 0, 0 }});
    left.additive_constant = barretenberg::fr::to_montgomery_form({{ static_cast<uint64_t>(other.additive_constant), 0, 0, 0 }});
    field_t<ComposerContext> right = accumulators[31];
    right.multiplicative_constant = barretenberg::fr::to_montgomery_form({{ static_cast<uint64_t>(multiplicative_constant), 0, 0, 0 }});
    right.additive_constant = barretenberg::fr::to_montgomery_form({{ static_cast<uint64_t>(additive_constant), 0, 0, 0 }});
...
bool_t<ComposerContext> uint32<ComposerContext>::operator!=(uint32 &other)
{
    ...
    field_t<ComposerContext> denominator(context, witness_t(inverse));
...
template <typename ComposerContext>
uint32<ComposerContext> uint32<ComposerContext>::operator~()
{
...
template <typename ComposerContext>
uint32<ComposerContext> uint32<ComposerContext>::operator>>(const uint32_t shift)
{
    if (shift == 0)
    {
        return (*this);
...
template <typename ComposerContext>
uint32<ComposerContext> uint32<ComposerContext>::ror(const uint32_t const_rotation)
{
...
template <typename ComposerContext>
uint32<ComposerContext> uint32<ComposerContext>::rol(const uint32_t const_rotation)
{
    if (const_rotation == 0)
    {
        return (*this);
