...
{
template <typename base_field, typename Fq2Params>
class field2
{
public:
struct field_t
...
static inline void __paralell_double_and_add_without_reduction(field_t &x_0, const field_t &y_0, const field_t &y_1, field_t &r)
{
    __add(x_0, x_0, x_0);
    __add(y_0, y_1, r);
}
