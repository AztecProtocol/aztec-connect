 ...
 * r1 in registers (r8, r9, r10, r11)
 * r2 = inregisters (r12, r13, r14, r15)
 **/
#define PARALLEL_DOUBLE_ADD(c)                                                                                           \
        "adcxq %%r8, %%r8                       \n\t"                                                                    \
        "adoxq 0(" c "), %%r12                  \n\t"                                                                    \
        "adcxq %%r9, %%r9                       \n\t"                                                                    \
        "adoxq 8(" c "), %%r13                  \n\t"                                                                    \
...
/**
 * Take a 4-limb field element, in (%r12, %r13, %r14, %r15),
 * double it, and reduce modulo p
 **/
#define DOUBLE_REDUCE(modulus_0, modulus_1, modulus_2, modulus_3)                                                        \
        "adcxq %%r12, %%r12                     \n\t"                                                                    \
        "movq  %%r12, %%r8                      \n\t"                                                                    \
        "adoxq " modulus_0 ", %%r12             \n\t"                                                                    \
        "adcxq %%r13, %%r13                     \n\t"                                                                    \
...
/**
 * Compute Montgomery suqaring of a
