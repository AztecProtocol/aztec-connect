...
void compute_wnaf_state(multiplication_runtime_state &state, wnaf_runtime_state &wnaf_state, fr::field_t *scalars, g1::affine_element *points, size_t num_initial_points, fr::field_t *endo_scalars);
