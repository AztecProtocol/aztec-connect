    ...
    if constexpr (GroupParams::small_elements) {
        ...
        __asm__ __volatile__("xorq %%r8, %%r8                              \n\t"
                             ...
                             : "r"(src),
                               "r"(dest),
                               "r"(predicate),
                               [modulus_0] "i"(coordinate_field::field_t::twice_modulus.data[0]),
                               [modulus_1] "i"(coordinate_field::field_t::twice_modulus.data[1]),
                               [modulus_2] "i"(coordinate_field::field_t::twice_modulus.data[2]),
                               [modulus_3] "i"(coordinate_field::field_t::twice_modulus.data[3])
