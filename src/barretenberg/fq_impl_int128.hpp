...
inline bool gt(uint64_t *a, uint64_t *b)
{
    bool t0 = a[3] > b[3];
...
inline void subtract(const uint64_t *a, const uint64_t *b, uint64_t *r)
{
    uint64_t borrow = 0;
    uint64_t carry = 0;
...
inline void montgomery_reduce(uint64_t *r, uint64_t *out)
{
    uint64_t carry = 0;
    uint64_t carry_2 = 0;
    uint64_t stub = 0;
...
inline void mul(uint64_t *lhs, uint64_t *rhs, uint64_t *r)
{
    uint64_t temp[8];
...
inline void sqr(uint64_t *a, uint64_t *r)
{
    uint64_t temp[8];
    mul_512(a, a, &temp[0]);
    montgomery_reduce(&temp[0], r);
...
inline void sub(uint64_t* a, uint64_t* b, uint64_t* r)
{
    subtract(a, b, r);
}

inline void mul_512(uint64_t *a, uint64_t *b, uint64_t *r)
{
    uint64_t carry = 0;
...
inline void to_montgomery_form(uint64_t *a, uint64_t *r)
{
...
inline void from_montgomery_form(uint64_t *a, uint64_t *r)
{
    mul(a, one_raw, r);
}
