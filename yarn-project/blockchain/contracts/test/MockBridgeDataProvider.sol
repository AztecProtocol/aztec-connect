...
import {IBridgeDataProvider} from '../interfaces/IBridgeDataProvider.sol';
import {AztecTypes} from '../AztecTypes.sol';

/**
 * @dev Warning: do not deploy in real environments, for testing only
 */
contract MockBridgeDataProvider is IBridgeDataProvider {
    ...
    function setBridgeData(uint256 _bridgeAddressId, address _bridgeAddress, uint256 _subsidy, string memory _description) public {
        bridges[_bridgeAddressId] = BridgeData({
