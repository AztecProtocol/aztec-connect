...
import { HashInputs } from './hash_inputs.js';
import { getRollupData } from '../verifier/fixtures/get_rollup_data.js';
import { EthersAdapter } from '../../provider/index.js';
import { EthAddress } from '@aztec/barretenberg/address';
import { StandardVerifier } from '../verifier/standard_verifier.js';
...
describe('hashInputs', function () {
  ...
  it('should verify hash inputs valid', async () => {
    const { proofData, broadcastData } = getRollupData(3, 2);
