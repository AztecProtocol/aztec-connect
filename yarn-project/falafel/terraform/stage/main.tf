...
[
  {
    ...
    "environment": [
      ...
      {
        "name": "ETHEREUM_HOST",
        "value": "https://${var.DEPLOY_TAG}-eth-host.aztec.network:8545/${var.STAGE_KEBAB_API_KEY}"
      },
      {
        "name": "PRIVATE_KEY",
        "value": "${var.STAGE_FORK_ROLLUP_PROVIDER_PRIVATE_KEY}"
      },
      {
        "name": "SERVER_AUTH_TOKEN",
        "value": "${var.STAGE_SERVER_AUTH_TOKEN}"
      },
      {
        "name": "API_PREFIX",
