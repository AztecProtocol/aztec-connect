...
import { AccountProofInputJson, JoinSplitProofInputJson, ProofOutputJson } from '../proofs/index.js';
...
export class CoreSdkDispatch extends EventEmitter implements CoreSdkSerializedInterface {
  ...
  public deriveLegacySigningMesasgeHash(address: string) {
    return this.request('deriveLegacySigningMessageHash', [address]);
  }
