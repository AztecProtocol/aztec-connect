...
export interface ILido extends BaseContract {
  ...
  functions: {
    ...
    getPooledEthByShares(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;

    getSharesByPooledEth(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
