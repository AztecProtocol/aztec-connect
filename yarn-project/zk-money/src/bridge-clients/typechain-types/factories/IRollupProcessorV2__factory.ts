...
import type { IRollupProcessorV2, IRollupProcessorV2Interface } from '../IRollupProcessorV2.js';
...
export class IRollupProcessorV2__factory {
  static readonly abi = _abi;
  static createInterface(): IRollupProcessorV2Interface {
    return new utils.Interface(_abi) as IRollupProcessorV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IRollupProcessorV2 {
    return new Contract(address, _abi, signerOrProvider) as IRollupProcessorV2;
  }
}
