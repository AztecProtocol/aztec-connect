...
export interface UniswapDCABridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'rebalanceAndFillUniswap()', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'rebalanceAndFillUniswap(uint256)', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'rebalanceAndFillUniswap()', data: BytesLike): Result;
...
export interface UniswapDCABridge extends BaseContract {
  ...
  'rebalanceAndFillUniswap()'(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    'rebalanceAndFillUniswap()'(overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
  ...
  estimateGas: {
    ...
    'rebalanceAndFillUniswap()'(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
