...
import { BridgeCallData, AssetValue, EthereumProvider, EthAddress } from '@aztec/sdk';
...
import { default as ElementBridge } from './abis/bridges/ElementBridge.sol/ElementBridge.json' assert { type: 'json' };
import { default as IVault } from './abis/bridges/IVault.sol/IVault.json' assert { type: 'json' };
import { default as RollupProcessor } from './abis/contracts/RollupProcessor.sol/RollupProcessor.json' assert { type: 'json' };
