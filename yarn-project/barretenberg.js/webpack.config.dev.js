 ...
 * In the meantime, we build a development version of the node worker into the wasm directory. The code in the worker
 ...
 *
 * If you're reading this message, and node 18 is out with loader chaining, be a good engineer and investigate if you
 * if ts-node and yarn pnp module loader can work together, then we can remove this.
 */
...
export default {
  ...
  output: {
    path: resolve(dirname(fileURLToPath(import.meta.url)), './src/wasm'),
