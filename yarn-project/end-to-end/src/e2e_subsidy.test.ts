 ...
 * have been included. - The state will move from PENDING -> AWAITING_SETTLEMENT.
 *
...
describe('end-to-end subsidy test', () => {
  ...
  it('should make a defi deposit and then withdraw', async () => {
    ...
    // Account 0 swaps ETH to token A.
    {
      ...
      // As this is a synchronous defi action, the tx status jumps to awaiting finalisation immediately
