...
import { getAccountsLegacy } from './legacy_aztec.js';
import { getAccountsConnect } from './aztec_connect.js';
import { mkdirSync } from 'fs';


async function writeAndVerifyAccounts(accountsFile: string, accounts: AccountData[]): Promise<AccountData[]> {
  //const debug = createDebugLogger('am:migrate_accounts');
  //const log = createLogger('am:migrateAccounts');
