...
type UserTx = UserAccountTx | UserDefiTx | UserDefiClaimTx | UserPaymentTx;
...
const toUserPaymentTx = (
  { txId, accountPublicKey, proofId, publicOwner, isSender, created, settled }: CorePaymentTx,
  value: AssetValue,
  fee: AssetValue,
) => {
  return new UserPaymentTx(txId, accountPublicKey, proofId, value, fee, publicOwner, isSender, created, settled);
};
...
export const groupTxs = (txs: CoreUserTx[]) => {
