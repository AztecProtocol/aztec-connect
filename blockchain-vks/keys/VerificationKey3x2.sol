// Verification Key Hash: 477cab2089b0142d496d46f3eb05bde26cb5795e4b02da54b7d61e06c64838b0
...
library VerificationKey3x2 {
    ...
    function get_verification_key() external pure returns (StandardTypes.VerificationKey memory) {
        ...
        assembly {
            ...
            mstore(mload(add(vk, 0xc0)), 0x00a48d98ac0345d0adf17ab5c0a46fc6fe5f1176c426c66878b9913b850cfcd9)//vk.Q2
            mstore(add(mload(add(vk, 0xc0)), 0x20), 0x0d4fba6c8d7f1817a3386793715f1e3a9fd7b5a42a185dc5a9501753afa5dd20)
