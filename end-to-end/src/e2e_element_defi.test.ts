...
describe('end-to-end async defi tests', () => {
  ...
  it('should deposit and redeem assets with element', async () => {
    ...
    // Wait for the token deposits to settle and set the blockchain time to start of Jan 2022
    {
    ...
    // We now have the assets in the platform, make the first batch of Element deposits
    {
    ...
    // make the second batch of deposits
    ...
    // Wait for the first batch to complete and settle
    {
    ...
    // Flush the remaining finalised interactions through to settlement
    {
