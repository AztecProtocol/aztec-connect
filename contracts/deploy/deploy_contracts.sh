...
if [ -z "$LAST_COMMIT" ]; then
  ...
  docker run \
    ...
    -e ETHEREUM_HOST=$ETHEREUM_HOST -e PRIVATE_KEY=$TF_VAR_PRIVATE_KEY -e DEPLOY_CONTRACTS=true -e UPGRADE=true -e ROLLUP_PROVIDER_ADDRESS=$TF_VAR_ROLLUP_PROVIDER_ADDRESS \
