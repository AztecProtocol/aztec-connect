...
import { WalletSdk, WalletProvider, SchnorrSigner, AssetId, EthAddress, toBaseUnits, WalletSdkUser } from '@aztec/sdk';
import { randomBytes } from 'crypto';

export class DepositingAgent {
  private wallet: Wallet;
  private address: EthAddress;
  private signer!: SchnorrSigner;
  private user!: WalletSdkUser;

  constructor(private sdk: WalletSdk, provider: WalletProvider, private masterWallet: Wallet, private id: number) {
    this.sdk = sdk;
