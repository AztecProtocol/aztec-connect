...
export async function deployFeeDistributor(signer: Signer, rollupProcessor: Contract) {
  ...
  const feeDistributor = await feeDistributorLibrary.deploy(rollupProcessor.address);
